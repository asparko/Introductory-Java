...
public class A3JediTester {
	...
	public static void main(String[] args) {
		...
		ip = iter.next();
		if (!pixel_compare(ip, orange)) {
			System.out.println("Expected 4th pixel from zigzag iterator to be orange");
		}
		ip = iter.next();
		if (!pixel_compare(ip, orange)) {
			System.out.println("Expected 5th pixel from zigzag iterator to be orange");
		}
		ip = iter.next();
		if (!pixel_compare(ip, orange)) {
			System.out.println("Expected 6th pixel from zigzag iterator to be orange");
		}

		ip = iter.next();
		if (!pixel_compare(ip, cyan)) {
			System.out.println("Expected 7th pixel from zigzag iterator to be orange");
		}
		ip = iter.next();
		if (!pixel_compare(ip, cyan)) {
			System.out.println("Expected 8th pixel from zigzag iterator to be orange");
		}
		ip = iter.next();
		if (!pixel_compare(ip, cyan)) {
			System.out.println("Expected 9th pixel from zigzag iterator to be orange");
		}
		...
		if (iter.hasNext()) {
			System.out.println("Expected zigzag iterator to be out of pixels");
			test_failed = true;
		}
