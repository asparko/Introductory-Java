...
//Constructor
	...
	public IndirectFrame(Frame source, int x_offset, int y_offset, int width, int height){
		...
		//Register this IndirectFrame to observe relevant part of the source frame
		sourceFrame.registerFrameObserver(this, interestArea);
	}
...
//Methods
	...
	@Override
	public void update(Frame frame, FrameArea changed) {
		//see if changed pixel is in interest area
		try{
			FrameArea intersect = changed.intersect(interestArea);
